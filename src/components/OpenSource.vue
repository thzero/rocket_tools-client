<script>
import QOpenSource from '@/library_vue_quasar/components/QOpenSource';
...
export default {
	...
	// 			},
		...
		return Object.assign(QOpenSource.setup(props), {
	...
	// 				licenseName: 'MIT',
	// 				licenseUrl: 'https://github.com/auth0/node-jsonwebtoken/blob/master/LICENSE'
	// 			},
	// 			{
	// 				category: 'server',
	// 				name: 'lodash',
